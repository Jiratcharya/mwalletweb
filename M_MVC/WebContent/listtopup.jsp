...
<div>
	<table class="heavyTable">
		...
		<tbody>
			...
			<c:forEach items="${listbalance}" var="mem">
				<tr>
					<td>${mem.topupdate}</td>
					<td>${mem.topuphistory}</td>

					<td><a href="budget.do?id=${mem.memberId}">Balance</a></td>
					<td><a href="deleteMem.do?id=${mem.memberId}">Cancel</a></td>
				</tr>
			</c:forEach>
		</tbody>
		<tfoot>
